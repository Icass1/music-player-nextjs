        ...
        return (
            <div className="w-fit h-fit relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col">
                {musicData.status === 404 ? (
                    <label className="text-center text-4xl font-bold text-neutral-100">
                        List not found
                    </label>
                ) : (
                    <></>
                ...
                <label className="text-center text-xs">
                    {musicData.status} {musicData.statusText}
                </label>
            </div>
        );
    } else if (musicData?.id === "") {
        return (
            <label className="w-fit h-fit relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col text-center text-4xl font-bold text-neutral-100">
                Loading...
            </label>
        );
    }
