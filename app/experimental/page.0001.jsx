...
import { SkipBack, SkipForward, Play, Pause, Volume2, Mic, Sun, Moon, Grid, List, Home, Library, Search, Menu, ChevronLeft, ChevronRight } from "lucide-react"
    ...
    if (showLyrics) {
      return (
        <div className="p-6">
          ...
          <pre className="whitespace-pre-wrap font-sans">{dummyLyrics}</pre>
        </div>
      )
    }
              ...
              <div className="p-4 space-y-2">
                {queue.map((item) => (
                  <div key={item.id} className="flex items-center space-x-2">
                    <Image src={`https://api.music.rockhosting.org/api/song/image/${item.id}_50x50`} alt='' width={40} height={40}/>
                    <div>
        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Image src={`https://api.music.rockhosting.org/api/song/image/${currentSong.id}_64x64`} className='rounded' alt='' width={64} height={64}/>
              <div>
