...
export default function SongInfo() {
    ...
    // useEffect(() => {
    //     songDataRef.current.addEventListener('touchstart', handleTouchStart, false);
    //     songDataRef.current.addEventListener('touchmove', handleTouchMove, false);
    ...
    useEffect(() => {
        ...
        const handleTouchEnd = (event) => {
            ...
            console.log("handleTouchEnd", songDataRef.current.scrollLeft - songDataRef.current.offsetWidth, songDataRef.current.offsetWidth / 3)

            if (Math.abs(songDataRef.current.scrollLeft - songDataRef.current.offsetWidth) > songDataRef.current.offsetWidth / 3) {
