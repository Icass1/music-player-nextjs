...
export default function Layout({ children }) {
    ...
    const handleDrop = (event) => {
        ...
        if (spotifyUrl.includes("open.spotify.com") && (spotifyUrl.includes("playlist") || spotifyUrl.includes("album"))) {
    ...
    return (
        <>
            ...
            <div
                className={clsx('fixed top-0 left-0 right-0 bottom-0 bg-neutral-900/80 z-50', { "hidden": !dragOver })}
