            ...
            <ContextMenuContent className="w-64">
                ...
                <ContextMenuItem
                    ...
                    onClick={() => {
                        ...
                        mediaPlayer.handlePlayList(item.id);
                    }}
                >
                    Play
                </ContextMenuItem>
                ...
                <ContextMenuSeparator />
                <ContextMenuItem inset>Add to queue</ContextMenuItem>
                <ContextMenuItem inset>Add to bottom of queue</ContextMenuItem>
                <ContextMenuSeparator />
                <ContextMenuItem inset>Remove from library</ContextMenuItem>
                <ContextMenuSeparator />
                <ContextMenuSub>
    ...
    return (
        <Link href={`/experimental/list/${item?.id}`}>
            <div className="bg-card text-card-foreground rounded-lg overflow-hidden shadow-md relative hover:scale-105 transition-[transform] cursor-pointer">
                <div className="bg-neutral-500 aspect-square w-full h-auto rounded overflow-hidden"></div>
                {item !== null ? (
                    <Image
                        onLoad={() => {
                            setCoverLoaded(true);
            ...
            <div className="bg-neutral-500 h-16 w-16 relative rounded">
                {item !== null ? (
                    <Image
                        ...
                        src={`https://api.music.rockhosting.org/api/list/image/${item.id}_300x300`}
                        className="left-0 absolute rounded"
                        width={64}
                        height={64}
                        alt=""
                    />
...
export default function UserLibrary() {
    ...
    return (
        <ScrollArea
            ...
            className="px-6 h-full relative"
        >
            ...
            {data == null ? showSkeleton() : showLists()}
        </ScrollArea>
    );
}
