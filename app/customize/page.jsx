        ...
        <>
            <div className="flex flex-row gap-4 items-center">
                ...
                <input
                    ...
                    style={{
                        background: `linear-gradient(90deg, rgb(0, ${green}, ${blue}) 0%, rgb(255, ${green}, ${blue}) 100%`,
                    }}
                    value={red}
                    onChange={handleRed}
                    min={0}
            ...
            <div className="flex flex-row gap-4 items-center">
                ...
                <input
                    ...
                    className="custom-slider appearance-none rounded-full"
                    style={{
                        background: `linear-gradient(90deg, rgb(${red}, 0, ${blue}) 0%, rgb(${red}, 255, ${blue}) 100%`,
                    }}
                    value={green}
            ...
            <div className="flex flex-row gap-4 items-center">
                ...
                <input
                    ...
                    className="custom-slider appearance-none rounded-full"
                    style={{
                        background: `linear-gradient(90deg, rgb(${red}, ${green}, 0) 0%, rgb(${red}, ${green}, 255) 100%`,
                    }}
                    value={blue}
                    onChange={handleBlue}
                    min={0}
...
export default function Custom() {
    ...
    useEffect(() => {
        ...
        setForeground1(
            getComputedStyle(document.body)
                .getPropertyValue("--foreground-1")
                .split(" ")
                .map((value) => Number(value)),
        );
        setForeground2(
            getComputedStyle(document.body)
                .getPropertyValue("--foreground-2")
                .split(" ")
                .map((value) => Number(value)),
        );
    }, []);
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center gap-4 mt-4  mb-4">
                ...
                <div
                    className="relative w-96 h-52 rounded-md"
                    style={{
                        background: `rgb(${background1[0]}, ${background1[1]}, ${background1[2]})`,
                    }}
                ></div>
            </div>
            ...
            <button
                className="relative block ml-auto mr-auto mt-4 mb-4 bg-neutral-800 p-3 pl-6 pr-6 rounded-lg text-green-300"
                onClick={handleApply}
            >
                Apply
            </button>
            ...
            <div className="flex flex-col ml-auto mr-auto w-fit gap-1 mt-20 mb-4 pb-2 bg-neutral-800 rounded-lg">
                <div className="relative bg-neutral-700 rounded-t-lg pt-1 pb-1">
                    ...
                    <button
                        className="absolute top-[5px] right-3 text-sm"
                        onClick={handleCopy}
                    >
                        Copy
                    </button>
                ...
                <label className="ml-3 mr-3">
                    --background-1:{" "}
                    <label style={{ color: "rgb(180, 133, 137)" }}>
                        {background1.join(" ")}
                    </label>
                    ;
                </label>
