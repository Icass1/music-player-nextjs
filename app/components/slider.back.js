    ...
    const Input = () => (
        <input
            ...
            {...(mouseOver
                ? {
                      style: {
                          background: `linear-gradient(90deg, #ca8a04 0%, #ca8a04 calc(0.2rem + (100% - 0.4rem)*${sliderValue}), black calc(0.2rem + (100% - 0.4rem)*${sliderValue}), black 100%)`,
                      },
                  }
                : {
                      style: {
                          background: `linear-gradient(90deg, rgb(150, 150, 150) 0%, rgb(150, 150, 150) calc(0.2rem + (100% - 0.4rem)*${sliderValue}), black calc(0.2rem + (100% - 0.4rem)*${sliderValue}), black 100%)`,
                      },
                  })}
            min="0"
            max="1"
